...
// Check && plot: python check_solution.py data/scenario_050.json /workspaces/WTA/data/scenario_050_solution.json && python plot.py data/scenario_050.json /workspaces/WTA/data/scenario_050_solution.json --out plot.png